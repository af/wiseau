...
// Target objects each represent a parsed object from the config file's
// "targets" section.
...
BuildConfig.prototype = {
    ...
    // Populates this.targets with Target instances, using data from the
    // config file.
